...
bool Client::ajouterarchive(){
    ...
    QString id_string= QString ::number(id);
          ...
          query.prepare("INSERT INTO Client (id,nom,prenom,adressemail,dateeffectation) "
                        "VALUES (:id, :nom, :prenom,:adressemail, :dateeffectation)");
          query.bindValue(":id", id);
          query.bindValue(":nom", nom);
          query.bindValue(":prenom", prenom);
          query.bindValue(":adressemail", adressemail);
           query.bindValue(":dateeffectation", dateeffectuation);
         return query.exec();
}
...
{QSqlQueryModel* model=new QSqlQueryModel();
    ...
    model->setHeaderData(2,Qt::Horizontal,QObject::tr("prenom"));
    model->setHeaderData(3,Qt::Horizontal,QObject::tr("adressemail"));
     model->setHeaderData(3,Qt::Horizontal,QObject::tr("dateeffectation"));
