...
void gestionclient::on_chat_box_clicked()
{
    MessengerClient MS;
    MS.exec();
}
...
void gestionclient::on_pushButton_archiverd_clicked()
{
    ...
    QString dateeffectuation = ui->tab_cli->model()->data(ui->tab_cli->model()->index(ui->tab_cli->currentIndex().row(),4)).toString();
    QString sexe = ui->tab_cli->model()->data(ui->tab_cli->model()->index(ui->tab_cli->currentIndex().row(),5)).toString();
   Client C(id ,nom , prenom , adressemail , dateeffectuation , sexe) ;
...
void gestionclient::on_pushButton_desarchiver_do_clicked()
{
    ...
    QString dateeffectuation = ui->archiveView->model()->data(ui->archiveView->model()->index(ui->archiveView->currentIndex().row(),4)).toString();
